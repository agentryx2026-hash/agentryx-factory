...
|---|---|---|---|
| Foundation | 0, 1, 1.5, 2, 2.5, 2.75, 3, 4, 5-A, 6-A, 7-A, 8-A, 9-A, 10-A, 11-A, 12-A, 13-A, 14-A | Phase 15 (Self-Improvement) next | 5-B, 6-B, 7-E, 8-B (need OpenRouter credit); 9-B, 10-B, 11-B, 12-B, 13-B, 14-B (need user creds + UI work); 7-B/C/D (scale-dependent) |
