...
| 17 | [Training Videos](Phase_17_Training_Videos/Phase_17_Plan.md) | ElevenLabs voiceover + headless browser screen capture stitched | 🟡 17-A done (3-category provider registry, beat-level failure-isolated renderer, E2E through Phase 16-A training-gen, 91 assertions); 17-B deferred (real TTS + capture + ffmpeg + Phase 14 handler + Phase 9 Verify + cloud upload, needs OpenRouter credit + TTS credentials) |
